defmodule Elementary.AppcenterDashboardWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: Elementary.AppcenterDashboardWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/appcenter_dashboard_web/templates",
        namespace: Elementary.AppcenterDashboardWeb
